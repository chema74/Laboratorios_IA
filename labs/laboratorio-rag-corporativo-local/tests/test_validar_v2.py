...
def cargar_modulo():
    ...
    spec = importlib.util.spec_from_file_location("validar_v2_rag", ruta)
...
def crear_estructura_minima(base: Path) -> None:
    ...
    for nombre in [
        ...
        (scripts / nombre).write_text("# archivo de prueba\n", encoding="utf-8")
    ...
    for nombre in [
        ...
        (tests / nombre).write_text("def test_dummy():\n    assert True\n", encoding="utf-8")
