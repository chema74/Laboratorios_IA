...
La V2 añade una capa operativa para revisar si el repositorio contiene los elementos mínimos esperados para una demostración profesional de privacidad aplicada a IA.
...
- Identificación de artefactos de privacidad.
- Comprobación de ausencia de dependencias cloud obligatorias.
- Verificación de documentación de límites.
- Revisión de evidencias reproducibles.
- Separación entre demostración técnica y asesoría legal.
