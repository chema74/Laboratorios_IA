...
- Construcción de narrativa semanal sintética de 7 días (configurable).
- Generación de línea temporal, episodios narrativos y mapa de evidencias.
- Exportación de resumen, guion de demo y expediente técnico en formatos JSON, CSV y Markdown.

## Fase de consolidación inmediata
- Alinear estructura narrativa con nuevas evidencias que se añadan en V1 extendida.
- Añadir más variantes narrativas por sector empresarial sintético.
