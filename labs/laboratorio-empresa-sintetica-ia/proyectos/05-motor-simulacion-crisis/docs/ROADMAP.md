# Roadmap de 05-motor-simulacion-crisis
...
- Evaluación de impacto sintético y resumen.
- Exportación JSON, CSV y expediente Markdown.
- CLI local y pruebas unitarias iniciales.

## Fase de ampliación local
- Reglas de dependencia entre crisis.
